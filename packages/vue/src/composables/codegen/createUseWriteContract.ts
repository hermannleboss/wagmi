  ...
  if (props.address !== undefined && typeof props.address === 'object')
    return (parameters) => {
      ...
      const writeContract = (variables: any, options?: any) => {
        const chainId = variables.chainId ?? configChainId.value
        ...
        result.writeContract(mergedVariables, options)
      }
      ...
      const writeContractAsync = (variables: any, options?: any) => {
        ...
        return result.writeContractAsync(mergedVariables, options)
      }
